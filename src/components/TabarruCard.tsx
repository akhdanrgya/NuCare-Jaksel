...
import { zakatMaal, zakatPertanian, zakatSimpanan } from "@/data/zakat";
  ...
  useEffect(() => {
    if (donationType === "zakat") {
      if (zakatType === "maal") {
        ...
        setCalculatedZakat(zakatSimpanan())
      }
    }
          ...
          <div className="w-full max-w-md p-6 mx-auto bg-white rounded-lg shadow-md">
            ...
            <div className="mb-4">
              ...
              >
                ...
                <option value="simpanan">Zakat Emas, Perak dan Logam mulia</option>
              </select>
